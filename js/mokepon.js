...
function seleccionarMascotaJugador(){
        ...
        else if (inputRatigueya.checked){spanMascotaJugador.innerHTML='Ratigueya'}else{alert('Selecciona una mascota')}
...
function seleccionarMascotaEnemigo(){
 ...
 else if    (mascotaAleatoria==2){spanMascotaEnemigo.innerHTML='Capipepo'}
...
function crearMensajefinal(resultadofinal){ 
    ...
    let sectionReiniciar=document.getElementById("reiniciar")
    sectionReiniciar.style.display="blocks"
